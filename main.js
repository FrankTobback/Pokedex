...
$(document).keydown(function (e) {
    if (e.keyCode === 13) {
        ...
        $.get('https://pokeapi.co/api/v2/pokemon/' + pokemonName, function (data) {
            ...
            $('#photo2').attr('src', data.sprites.back_default);
            $('#photo3').attr('src', data.sprites.front_shiny);
            $('#photo4').attr('src', data.sprites.back_shiny);
            for (i = 0; i < 4; i++) {
                ...
                $.get('https://pokeapi.co/api/v2/pokemon-species/' + data.id, function (data2) {
                    ...
                    if (vorige == null) {
                        ...
                        $.get('https://pokeapi.co/api/v2/pokemon/' + vorige.name, function (vorigefoto) {
                            ...
                            $('#photo5').attr('src', vorigefoto.sprites.front_default);
                        });
                      }
                  });
               }
